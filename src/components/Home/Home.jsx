        ...
        <div className='details'>
            ...
            <div className='icons'>
                ...
                <div className='resume'>
                    <div className='res'><a href="https://drive.google.com/file/d/1Kx5zyKD8LyW65oobnZJtDEQSbpHa2TJH/view?usp=sharing" target = "_blank">Resume</a></div>
                    <div className='res'><a href="https://mail.google.com/mail/?view=cm&to=bgrnaidu%40gmail.com" target = "_blank">Hire Me</a></div>
                </div>
            </div>
        </div>
        <div className='pic'>
            <div className='gova-pic'>
            <img src={Govardhan}/>
            </div>
        </div>
    </div>
